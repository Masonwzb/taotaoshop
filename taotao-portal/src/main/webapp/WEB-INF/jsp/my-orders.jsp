...
<link type="text/css" rel="stylesheet" href="/css/a.css">
	<link type="text/css" rel="stylesheet" href="/css/a_002.css"
		source="combo">
		<script type="text/javascript" src="/js/a_002"></script>
								...
								<table class="tb-void">
									...
									<c:forEach items="${orderList}" var="order">
										<tbody id="tb-${order.orderId} ">
											...
											<!-- *************商品遍历开始*************** -->
												<c:forEach items="${order.orderItems}" begin="0" end="0" var="item" >
												<td>
													<div class="img-list">
														<a href="/item/${item.itemId }.html" class="img-box"
												...
												<td rowspan="1">
													<div class="amount">
														<span>总额 &#165;${order.payment }</span> <br> <strong>应付</strong>
															<br> <strong>&#165;${order.payment }</strong> <br> <span
																	class="ftx-13">在线支付</span>
													</div>
												</td>
												<td>
													<jsp:useBean id="timestamp" class="java.util.Date"/> 
													<jsp:setProperty name="timestamp" property="time" value="${order.createTime}"/>  
													<span class="ftx-03"><fmt:formatDate value="${timestamp }" pattern="yyyy-MM-dd HH:mm:ss"/></span>
													<input type="hidden" id="datasubmit-2538292730"
													value="<fmt:formatDate value="${timestamp }" pattern="yyyy-MM-dd HH:mm:ss"/>">
												</td>

												<td rowspan="1">
													<div class="status">
														<span class="order-status ftx-04"> ${order.status} </span> <br>
															<a
															href="https://details.jd.com/normal/item.action?orderid=78781803334&amp;PassKey=8255C720EF9C1139E61C96148668365B"
												...
												<td id="operate2538292730" class="order-doi" width="100">
													...
													<div class="operate">
														...
														<a
															href="https://cashier.jd.com/payment/pay.action?id=78781803334&amp;total=228.00&amp;companyid=10&amp;OrderType=0&amp;key=EAB06D1BB17D729267F764ABA19120A878B0FE18AC630F27"
															class="btn-pay"
															clstag="click|keycount|orderinfo|order_pay"
															target="_blank">付款</a><br> <a
															class="a-link order-cancel" href="javascript:void(0);"
															data-dialog-version="201707" _oid="78781803334"
															_passkey="3C2D8F8C4098EE60C37F15E6C15E0FA0"
															_url="new/2017/cancelOrder.html?1&amp;cancalText=0&amp;priceProtection=0&amp;isHaveGiftOrder=0&amp;status=">取消订单</a><br>
													</div>
											...
											<tr id="track${order.orderId}" oty="0,1,70" class="tr-td">
											<!-- *************商品遍历开始*************** -->
												<c:forEach items="${order.orderItems}" begin="1" var="item" >
												<td>
													<div class="img-list">
														<a href="/item/${item.itemId }.html" class="img-box"
															clstag="click|keycount|orderinfo|order_product"
