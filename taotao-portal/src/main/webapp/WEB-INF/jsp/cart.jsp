    ...
    <div id="product-list" class="cart-tbody">
        ...
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_${cart.id }" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            <div class="cell p-checkbox"><input data-bind="cbid:1" class="checkbox" type="checkbox" name="checkItems" checked="" value="${cart.id }-1"></div>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="checkboxChanges"></span>
          </div>
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="javascript:goToOrder();" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          ...
                          <a href="javascript:goTotaotaoOrder();" class="checkout-jd">去淘淘结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
...
//全选或者全不选
	...
	function setSelectAll(){  
	    var chsub = $("input[type='checkbox'][name='checkItem']").length; //获取subcheck的个数  
	    var checkedsub = $("input[type='checkbox'][name='checkItem']:checked").length; //获取选中的subcheck的个数  
	    if (checkedsub == chsub) {  
	        $("#toggle-checkboxes_up").prop("checked", true);  
			$("#toggle-checkboxes_down").prop("checked", true);  
	    }
